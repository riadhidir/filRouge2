...
const Statistics = () => {
    ...
    const {
        ...
        refetch,
        isRefetching,
    } = useQuery(["stats",university], async () => {
        ...
        <>
            <section className=" ">
                ...
                <div className="grid lg:grid-cols-12 gap-5   ">
                    ...
                    <div className="flex h-fit justify-between group col-span-12 lg:col-span-4 bg-white shadow-md  hover:shadow-xl items-center p-4 rounded-lg   hover:bg-indigo-600  border-0 border-indigo-600 hover:border-white transition-all ">
                    ...
                    <div className="flex h-fit justify-between group col-span-12 lg:col-span-4 bg-white shadow-md  hover:shadow-xl items-center p-4 rounded-lg   hover:bg-indigo-600  border-0 border-indigo-600 hover:border-white transition-all ">
                        <div className="w-[60%] h-full flex flex-col items-baseline  ">
                            ...
                            <p className=" text-4xl font-semibold  text-indigo-700 group-hover:text-white">
                                {stats?.Documents?.downloads.map((item)=> item._id === university? item.totalDownloads : '')} 
                            </p>
                        </div>
                        <div className=" h-20  ">
                            <Doughnut
